...
Config.SaveVehicleDamages = true -- true saves/restores damage state
Config.ShowVehicleImages = true -- loads thumbnails from vehicle_images
Config.EnableMileageTracking = true -- built-in mileage tracking while driving (stored in miles)
Config.AutoSQL = true
Config.VPark = true -- true enables 
Config.VParkBuyPrice = 250 -- charge to buy/update your parking spot
Config.VParkUseDistance = 20.0 -- max distance from your vpark spot for /vpark and /vlist retrieval
...
Config.ImpoundAllowedJobs = { "police" } -- default police-only impound access
...
Config.VFixAllowedGroups = { "admin", "superadmin" } -- ESX groups allowed to use /vfix
Config.Debug = true
